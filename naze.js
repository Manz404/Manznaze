...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: '©Manz', orderTitle: 'scurity', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Manz404", "caption": '©Manz', 'jpegThumbnail': thumb}}}
...
jumlahharian = `${dataa.value}`
	...
	if (db.data.settings[botNumber].autobio) {
	  ...
	  // Anti Link
        ...
        if (isCreator) return m.reply(`*maaf kamu owner bot ku yg ganteng 🤨*`)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan (cupu lu deck)`
